    ...
    public boolean onTouch(View view, MotionEvent motionEvent) {
        ...
        switch (motionEvent.getActionMasked()) {
            case MotionEvent.ACTION_DOWN: {
                ...
                final View relChild;
                if (lastItem != -1) {
                    relChild = mListView.getChildAt(lastItem);
                    final LinearLayout ll = (LinearLayout) relChild.findViewById(R.id.li_ll);
                    RelativeLayout rl = (RelativeLayout) relChild.findViewById(R.id.li_rl);
                    lastItem = -1;
                    rl.animate()
                            .translationX(0)
//                            .alpha(1)
                            ...
                            .setListener(new Animator.AnimatorListener() {
                                ...
                                public void onAnimationEnd(Animator animator) {
                                    if (relChild != null) {
                                        relChild.setBackgroundColor(Color.WHITE);
            ...
            case MotionEvent.ACTION_CANCEL: {
                ...
                if (mDownView != null && mSwiping) {
                    ...
                    // cancel
                    final LinearLayout ll = (LinearLayout) mDownView.findViewById(R.id.li_ll);
                    RelativeLayout rl = (RelativeLayout) mDownView.findViewById(R.id.li_rl);
...
//                            .alpha(1)
                            ...
                            .setListener(new AnimatorListenerAdapter() {
                                ...
                                public void onAnimationEnd(Animator animator) {
                                    if (mDownView != null) {
                                        mDownView.setBackgroundColor(Color.WHITE);
                                        ll.setVisibility(View.INVISIBLE);
                                        lastItem = -1;
                                    }
                                }
...
//                    mDownView.setTranslationX(deltaX - mSwipingSlop);
                    ...
                    rl.animate()
                            .translationX(deltaX - mSwipingSlop)
                            .setDuration(mAnimationTime)
                            .setListener(new AnimatorListenerAdapter() {

                                @Override
                                public void onAnimationEnd(Animator animator) {
                                    if (mDownView != null && Math.abs(deltaX) > 200) {
                                        mDownView.setBackgroundColor(Color.rgb(218, 112, 214));
